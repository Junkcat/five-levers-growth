        ...
        <div className="container mx-auto px-4 relative z-10 pt-20 pb-16">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-xl md:text-2xl mb-8 text-white/90 max-w-3xl mx-auto leading-relaxed">
              ...
              Потом уходим: всё что нужно для роста, остаётся внутри компании.
            </p>
            <Button
              size="lg"
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-6">
                Понимаем и стратегию, и продукт, и как обучить людей, и как провести
                изменения в большой организации. Это редкое сочетание — обычно это четыре
                разных специалиста.
              </p>
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              { title: "Передаём, не забираем", desc: "Методология, инструменты и навыки переходят к команде. После проекта компания продолжает расти самостоятельно." },
            ].map((f, i) => (
