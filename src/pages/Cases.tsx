...
const cases = [
  {
    ...
    result: "За 6 лет — с нуля до полноценной продуктовой лаборатории, которая работает самостоятельно. $XXМ+ прибыли, 100+ обученных продактов, 100+ запущенных инициатив.",
  },
  {
    company: "СИБУР",
